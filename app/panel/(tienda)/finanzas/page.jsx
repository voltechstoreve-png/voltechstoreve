...
import AuthGuard from '@/components/AuthGuard'; // ✅ NUEVO: Protección de ruta
import { 
  DollarSign, 
  TrendingUp, 
  TrendingDown,
...
export default function FinanzasPage() {
  ...
  return (
    // ✅ PROTECCIÓN DE RUTA: Solo usuarios con 'puedeVerFinanzas' (Admin/Socio) pueden ver esto
    <AuthGuard requiredPermission="puedeVerFinanzas">
